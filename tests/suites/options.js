...
test('setting the initial date with a Date', function(){
  var initialDate = new Date(2014, 10, 22);
  var input = $('<input />')
  .appendTo('#qunit-fixture')
  .val('2012-03-05')
  .datepicker({
  ...
  input.focus();
  equal(input.val(), '2014-11-22', "Input value has been set to the initial date.")
});

test('setting the initial date with a Function', function(){
  var input = $('<input />')
  .appendTo('#qunit-fixture')
  .val('2012-03-05')
  .datepicker({
    format: 'yyyy-mm-dd',
    initialDate: function() { return new Date(2014, 10, 24); }
  }),
  dp = input.data('datepicker'),
  picker = dp.picker,
  target;
  ...
  input.focus();
  equal(input.val(), '2014-11-24', "Input value has been set to the initial date.")
});
